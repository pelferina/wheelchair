...
public class RecognizerTask implements Runnable {
	...
	public RecognizerTask() {
		pocketsphinx
				.setLogfile("/sdcard/Android/data/zuoshu/pocketsphinx.log");
		Config c = new Config();
		/*
		 * In 2.2 and above we can use getExternalFilesDir() or whatever it's
		 * called
		 */
		c.setString("-hmm", "/sdcard/Android/data/pocketsphinx/model/hmm/en_US/hub4wsj_sc_8k");
		c.setString("-dict", "/sdcard/Android/data/pocketsphinx/model/lm/en_US/lin.dic");
		c.setString("-lm", "/sdcard/Android/data/pocketsphinx/model/lm/en_US/lin.lm");
